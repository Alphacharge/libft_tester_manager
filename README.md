...
4. The Script will ask for Installing or a run only.
    type <code>y</code> on first run
    
5. The Script will ask you for the Intra from the Person you are evaluating. Reason is different Foldersnames for a new eva.
    Insert the Intra of the Person you are evaluating:<code>Intra</code>
    
    
6. The Script will ask you for the git Repo you want to evaluate.
...
---
For a <b>2nd run</b> start the Script with 
    <code>./libft_tester_manager.sh</code>

Press "Enter"

Choose the Tester that you want:

<img width="597" alt="image" src="https://user-images.githubusercontent.com/94354053/165360946-96fc74bf-dd66-47c0-aca1-ffcbabbfa6fe.png">

---
Examples:

<img width="677" alt="image" src="https://user-images.githubusercontent.com/94354053/165360253-23554ace-1ac9-4815-82d0-d42d748fa47b.png">
